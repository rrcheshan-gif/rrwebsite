...
content = content.replace(
  /\.logo-text, \.footer-logo-text \{\s*display: flex !important;\s*flex-direction: column !important;\s*justify-content: center !important;\s*\}/,
...
console.log('Added translateY to logo text');
