...
import { ArrowRight, Flag, Construction, ShieldCheck, Map, Factory, Globe, ChevronRight } from 'lucide-react';
              ...
              {timelineEvents.map((event, idx) => (
                <div key={idx} style={{ 
                  ...
                  <div className="hover-lift" style={{ 
                    ...
                    <div style={{ color: 'var(--text-light)', fontSize: isMobile ? '1rem' : '1.1rem', lineHeight: 1.8, position: 'relative', zIndex: 2 }}>
                      {event.desc}
                    </div>
                  </div>
...
fs.writeFileSync('src/app/about/history/page.tsx', code, 'utf8');
console.log('Successfully rebuilt history page with modern design.');
