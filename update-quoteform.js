...
const quoteFormCode = `"use client";
...
fs.writeFileSync('src/app/components/QuoteForm.tsx', quoteFormCode, 'utf8');
console.log('Successfully updated QuoteForm component with props support');
