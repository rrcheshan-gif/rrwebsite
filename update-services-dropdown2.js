...
const regex = /<ul className="dropdown-menu">[\s\S]*?Technology &amp; Services<\/Link><\/li>[\s\S]*?Research &amp; Development<\/Link><\/li>\s*<\/ul>/;
...
content = content.replace(regex, newServicesDropdown);

fs.writeFileSync('src/app/components/Navbar.tsx', content, 'utf8');
console.log('Updated services dropdown');
