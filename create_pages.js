...
function createPage(slug, title, image, description) {
      ...
      <section style={{ padding: isMobile ? '60px 20px' : '100px 20px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', lineHeight: 1.8 }}>
            RR Construction brings decades of engineering excellence to ${title.toLowerCase()}. 
...
`;
  ...
  fs.writeFileSync(path.join(dir, 'page.tsx'), content.trim(), 'utf8');
}
...
createPage(
    ...
    'Formation, civil infrastructure, and track upgradation supporting Sri Lanka\\'s national rail network modernisation.'
);

console.log('Created the two missing service pages!');
