...
const targetStart = `<div style={{ maxWidth: '1100px', margin: '0 auto' }}>`;
const targetEnd = `</div>
      </section>`;
...
if (startIndex !== -1 && endIndex !== -1) {
    const newBlock = `<div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.78)', fontSize: isMobile ? '1rem' : '1.2rem', maxWidth: '800px', lineHeight: 1.75, margin: '20px 0 0 0', fontWeight: 400 }}>
    ...
    console.log('Fixed services page header.');
} else {
