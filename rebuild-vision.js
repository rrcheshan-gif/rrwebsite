...
import { ArrowRight, Target, Eye, ShieldCheck, HardHat, Lightbulb, Leaf, ChevronDown } from 'lucide-react';
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: \opacity 0.8s cubic-bezier(0.16, 1, 0.3, 1) \ms, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1) \ms\,
      }}
    >
      {children}
    </div>
