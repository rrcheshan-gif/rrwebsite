    ...
    <main style={{ backgroundColor: 'var(--white)', minHeight: '100vh' }}>
      ...
      <section 
        ...
        style={{ position: 'relative', 
          backgroundImage: "linear-gradient(rgba(17, 24, 39, 0.8), rgba(17, 24, 39, 0.8)), url('/images/BADULLA/WhatsApp Image 2026-07-28 at 14.03.18.jpeg')",
...
fs.writeFileSync('src/app/services/buildings-structures/page.tsx', civilContent, 'utf8');
  ...
  return (
    <main style={{ backgroundColor: 'var(--white)', minHeight: '100vh' }}>
      ...
      <section 
        className="page-header" 
        style={{ position: 'relative', 
          backgroundImage: "linear-gradient(rgba(17, 24, 39, 0.8), rgba(17, 24, 39, 0.8)), url('/images/IRCON-MANNAR/WhatsApp Image 2026-08-01 at 12.32.07.jpeg')",
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          color: 'var(--white)',
          padding: isMobile ? '40px 20px' : '70px 20px',
...
fs.writeFileSync('src/app/services/railway-civil-works/page.tsx', railwayContent, 'utf8');

console.log('Successfully wrote the detailed pages.');
