...
fs.writeFileSync('src/app/about/key-data/page.tsx', keyDataContent, 'utf8');
...
fs.writeFileSync('src/app/services/research-development/page.tsx', rndContent, 'utf8');
console.log("Rewrote Key Data and R&D pages to match the official theme design.");
