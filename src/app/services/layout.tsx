...
export const metadata: Metadata = {
  ...
  description: "RR Construction provides comprehensive heavy civil engineering services in Sri Lanka: highway and expressway construction, bridge construction, maritime construction, dredging & reclamation, water infrastructure, and landslide mitigation.",
  keywords: ["heavy civil engineering services Sri Lanka", "construction services Sri Lanka", "highway and expressway construction Sri Lanka", "bridge construction Sri Lanka", "maritime construction Sri Lanka", "dredging Sri Lanka", "water infrastructure Sri Lanka", "landslide mitigation Sri Lanka"],
  alternates: {
