...
export const metadata: Metadata = {
  title: 'Slope Stabilization & Landslide Mitigation in Sri Lanka | Geotechnical Engineering | RR Construction',
  ...
  openGraph: {
    title: 'Slope Stabilization & Landslide Mitigation Sri Lanka | RR Construction',
...
export default function Layout({ children }: { children: React.ReactNode }) {
  const serviceSchema = {
    ...
    '@type': 'Service',
    'name': 'Slope Stabilization, Landslide Mitigation and Geotechnical Engineering in Sri Lanka',
    'description': 'Expert landslide mitigation, slope stabilization and geotechnical engineering in Sri Lanka.',
    'provider': {
      '@type': 'Organization',
  ...
  const breadcrumbSchema = {
    ...
    'itemListElement': [
      ...
      { '@type': 'ListItem', 'position': 3, 'name': 'Slope Stabilization & Landslide Mitigation', 'item': 'https://www.rrconstruction.lk/services/landslide-mitigation' }
    ]
  };
