...
const SERVICES = [
  ...
  {
    slug: 'dredging-and-water-infrastructure',
    num: '04',
    title: 'Dredging & Water Infrastructure',
    subtitle: 'Capital Dredging • Land Reclamation • Coastal Works',
    desc: 'Capital dredging and coastal reclamation alongside end-to-end water infrastructure construction. We build treatment plants, transmission mains, and distribution networks.',
    highlights: ['Self-Owned Marine Fleet', 'ISO 14001 Compliance', 'Coastal Reclamation'],
    image: '/images/projects/filadhoo/img2.jpg',
    cta: '/services/dredging-and-water-infrastructure',
  },
  {
