...
export default function ServicePage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--white)' }}>
      ...
      <section style={{
        position: 'relative',
        backgroundImage: "url('" + encodeURI('/images/IRCON-MANNAR/WhatsApp Image 2026-08-01 at 12.32.07.jpeg') + "')",
      ...
      <section style={{ padding: isMobile ? '60px 20px' : '100px 20px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', lineHeight: 1.8 }}>
            RR Construction brings decades of engineering excellence to railway civil works. 
