...
export const metadata: Metadata = {
  ...
  description: "View RR Construction's extensive portfolio of mega heavy civil engineering and infrastructure projects across Sri Lanka, including highways, bridges, and maritime works.",
