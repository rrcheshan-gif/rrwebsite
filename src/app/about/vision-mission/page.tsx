    ...
    <div style={{ paddingTop: isMobile ? "90px" : "110px", backgroundColor: "var(--bg-light)", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <p style={{ color: "#cbd5e1", fontSize: isMobile ? "1.1rem" : "1.3rem", marginTop: "15px", maxWidth: "700px", display: "inline-block", lineHeight: 1.6, fontWeight: 500, textAlign: isMobile ? "justify" : "left" }}>
            ...
            <Reveal direction="left" style={{ flex: 1 }}>
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 2 }}>
                  ...
                  <p style={{ color: "var(--text-light)", fontSize: "1.15rem", lineHeight: 1.8, fontWeight: 500, margin: "0 0 15px 0", textAlign: isMobile ? "justify" : "left" }}>
            ...
            <Reveal direction="right" delay={300} style={{ flex: 1 }}>
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 2 }}>
                  ...
                  <p style={{ color: "var(--text-light)", fontSize: "1.1rem", lineHeight: 1.8, fontWeight: 500, margin: "0 0 15px 0", textAlign: isMobile ? "justify" : "left" }}>
            ...
            {[
              ...
              <Reveal key={idx} delay={idx * 150} direction="up">
                ...
                >
                  ...
                  <p style={{ color: "var(--text-light)", fontSize: "1rem", lineHeight: 1.6, margin: 0, fontWeight: 500, textAlign: isMobile ? "justify" : "left" }}>
                    {val.desc}
                  </p>
                </div>
              </Reveal>
      ...
      <section style={{ padding: "80px 20px 120px", background: "var(--white)", position: "relative" }}>
        <div className="container" style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          <Reveal>
            ...
            <p style={{ color: "var(--text-light)", fontSize: "1.15rem", lineHeight: 1.8, marginBottom: "30px", fontWeight: 500, textAlign: "center", maxWidth: "800px", margin: "0 auto 30px" }}>
            ...
            <p style={{ color: "var(--text-dark)", fontSize: "1.25rem", fontWeight: 800, fontFamily: "var(--font-heading)", textAlign: "center" }}>
