        ...
        <div className="container" style={{ maxWidth: "1000px", margin: "0 auto", padding: "0 16px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            <p style={{ color: "var(--text-light)", fontSize: "1.1rem", marginTop: "15px", maxWidth: "800px", margin: "15px auto 0" }}>
              From a regional contractor in {COMPANY_DATA.established} to a national heavy civil engineering powerhouse today.
            </p>
          </div>
            ...
            {timelineEvents.map((event, idx) => (
              ...
              >
                ...
                <div  style={{ 
                  ...
                  <span style={{ color: "var(--primary-red)", fontSize: "0.9rem", fontWeight: 700, letterSpacing: "1px",  display: "block", marginBottom: "10px" }}>
                    {event.epoch}
                  </span>
