...
const timelineEvents = [
  ...
  },
  {
    ...
    desc: <>RR Construction expanded its technical capabilities through major infrastructure projects for local and international clients. The <strong style={{ fontWeight: 'normal' }}>Queen Elizabeth Quay Project at the Port of Colombo in 2003</strong> strengthened the company's expertise in <Link href="/services/maritime-construction" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: 600 }}>maritime and heavy civil engineering</Link>, followed by the <strong style={{ fontWeight: 'normal' }}>Ampara Water Treatment Plant in 2006</strong>, which further developed its capabilities in <Link href="/services/water-infrastructure" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: 600 }}>water infrastructure</Link> and specialized civil construction.</>,
