...
const timelineEvents = [
  ...
  },
  {
    ...
    desc: <>RR Construction continues to deliver complex <Link href="/projects" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>infrastructure projects</Link> across Sri Lanka, with capabilities spanning <Link href="/services/road-construction" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>road and highway construction</Link>, <Link href="/services/bridge-construction" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>bridges</Link>, <Link href="/services/railway-civil-works" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>railway infrastructure</Link>, <Link href="/services/maritime-construction" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>maritime and harbour construction</Link>, <Link href="/services/water-infrastructure" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>water infrastructure</Link>, irrigation, <Link href="/services/landslide-mitigation" style={{ color: "var(--primary-red)", textDecoration: "none", fontWeight: "normal" }}>geotechnical and landslide mitigation</Link>, and other heavy civil engineering works across all provinces of Sri Lanka.</>,
