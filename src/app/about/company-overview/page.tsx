    ...
    <div style={{ paddingTop: isMobile ? "90px" : "110px", minHeight: "100vh", backgroundColor: "var(--bg-light)" }}>
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <h1 style={{ color: "white", fontFamily: "var(--font-heading)", fontSize: "clamp(2.5rem, 6vw, 4.2rem)", margin: 0, fontWeight: 800, textShadow: "0 4px 20px rgba(0,0,0,0.85)" }}>RR <span style={{ color: "var(--primary-red)" }}>Overview</span></h1>
        ...
        <div className="container" style={{ maxWidth: '1440px', margin: "0 0auto", padding: "0 16px" }}>
          ...
          <div style={{ width: "100%" }}>
            <p style={{ color: "var(--text-light)", fontSize: "1.1rem", lineHeight: 1.8, marginBottom: "30px", textAlign: "justify" }}>
              Founded in 1995, <strong>RR Construction (Pvt) Ltd</strong> is a leading <strong>construction and civil engineering company in Sri Lanka</strong>, delivering integrated solutions for major infrastructure and specialized construction projects across the country. With over three decades of industry experience, we have developed strong capabilities in <strong>road and highway construction, railway construction, bridge construction, maritime and marine construction, geotechnical engineering, earthworks, water infrastructure, aggregate production, and heavy civil engineering</strong>. Our railway construction capabilities further strengthen our position in Sri LankaÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s infrastructure sector, enabling us to contribute to the development, improvement, and maintenance of essential railway infrastructure through professional engineering expertise, modern equipment, and efficient project execution. As a <strong>100% Sri Lankan-owned company</strong>, RR Construction combines experienced engineers and a skilled workforce of <strong>1,400+ professionals</strong> with a proprietary fleet of <strong>1,000+ heavy construction machines</strong> and in-house aggregate production facilities, providing greater control over resources, material quality, project schedules, and construction efficiency. Our extensive operational capabilities enable us to undertake complex infrastructure developments while maintaining high standards of <strong>engineering excellence, quality assurance, occupational health and safety, environmental responsibility, sustainability, and timely project delivery</strong>. From <strong>road, highway and railway infrastructure to bridges, maritime and marine structures, geotechnical works, water infrastructure, and other major civil engineering developments</strong>, RR Construction provides reliable, durable, and cost-effective construction solutions tailored to the requirements of each project. Through continuous innovation, integrated project management, advanced construction resources, and a commitment to sustainable development, <strong>RR Construction (Pvt) Ltd</strong> continues to build resilient infrastructure that supports connectivity, economic growth, communities, and the long-term development of Sri Lanka.
            </p>
