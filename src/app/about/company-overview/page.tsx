        ...
        <div className="container" style={{ maxWidth: "1440px", margin: "0 0auto", padding: "0 16px" }}>
          ...
          <div style={{ width: "100%" }}>
            <p style={{ color: "var(--text-light)", fontSize: "1.1rem", lineHeight: 1.8, marginBottom: "30px", textAlign: "justify" }}>
              Founded in 1995, <strong style={{ fontWeight: 'normal' }}>RR Construction (Pvt) Ltd</strong> is a leading <strong style={{ fontWeight: 'normal' }}>construction and civil engineering company in Sri Lanka</strong>, delivering integrated solutions for major infrastructure and specialized construction projects across the country. With over three decades of industry experience, we have developed strong capabilities in <strong style={{ fontWeight: 'normal' }}>road and highway construction, railway construction, bridge construction, maritime and marine construction, geotechnical engineering, earthworks, water infrastructure, aggregate production, and heavy civil engineering</strong>. Our railway construction capabilities further strengthen our position in Sri Lanka’s infrastructure sector, enabling us to contribute to the development, improvement, and maintenance of essential railway infrastructure through professional engineering expertise, modern equipment, and efficient project execution. As a <strong style={{ fontWeight: 'normal' }}>100% Sri Lankan-owned company</strong>, RR Construction combines experienced engineers and a skilled workforce of <strong style={{ fontWeight: 'normal' }}>1,400+ professionals</strong> with a proprietary fleet of <strong style={{ fontWeight: 'normal' }}>1,000+ heavy construction machines</strong> and in-house aggregate production facilities, providing greater control over resources, material quality, project schedules, and construction efficiency. Our extensive operational capabilities enable us to undertake complex infrastructure developments while maintaining high standards of <strong style={{ fontWeight: 'normal' }}>engineering excellence, quality assurance, occupational health and safety, environmental responsibility, sustainability, and timely project delivery</strong>. From <strong style={{ fontWeight: 'normal' }}>road, highway and railway infrastructure to bridges, maritime and marine structures, geotechnical works, water infrastructure, and other major civil engineering developments</strong>, RR Construction provides reliable, durable, and cost-effective construction solutions tailored to the requirements of each project. Through continuous innovation, integrated project management, advanced construction resources, and a commitment to sustainable development, <strong style={{ fontWeight: 'normal' }}>RR Construction (Pvt) Ltd</strong> continues to build resilient infrastructure that supports connectivity, economic growth, communities, and the long-term development of Sri Lanka.
            </p>
