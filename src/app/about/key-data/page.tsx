      ...
      <section style={{ padding: isMobile ? "10px 10px 80px" : "20px 20px 120px" }}>
        <div className="container" style={{ maxWidth: "1200px", margin: "0 auto", padding: isMobile ? "0" : "0 16px" }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? '15px' : '25px' }}>
            ...
            {/* 1. Identity (Wide) */}
            <div className="hover-lift" style={{ gridColumn: isMobile ? 'span 1' : 'span 2', background: 'var(--white)', borderRadius: '32px', padding: isMobile ? '35px 25px' : '50px 60px', display: 'flex', flexDirection: 'column', justifyContent: 'center', boxShadow: '0 10px 40px rgba(0,0,0,0.04)', border: '1px solid var(--border-soft)', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <h2 style={{ fontSize: isMobile ? '2rem' : '3rem', fontFamily: 'var(--font-heading)', fontWeight: 800, color: 'var(--text-dark)', marginBottom: '30px', lineHeight: 1.1 }}>RR Construction <br/><span style={{ color: 'var(--text-light)' }}>(Pvt) Ltd</span></h2>
            ...
            <div className="hover-lift" style={{ background: 'var(--white)', borderRadius: '32px', padding: isMobile ? '35px 25px' : '40px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: '1px solid var(--border-soft)', boxShadow: '0 10px 40px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '10px', fontWeight: 500 }}>Heavy Machinery Units</p>
              </div>
            </div>
            ...
            <div className="hover-lift" style={{ background: 'var(--white)', borderRadius: '32px', padding: isMobile ? '35px 25px' : '40px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: '1px solid var(--border-soft)', boxShadow: '0 10px 40px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ marginTop: '40px' }}>
                ...
                <p style={{ color: 'var(--text-light)', fontSize: '1.1rem', marginTop: '10px', fontWeight: 500 }}>Major National Projects</p>
              </div>
            </div>

            {/* 6. Head Office (1/3) */}
            <div className="hover-lift" style={{ background: 'var(--white)', borderRadius: '32px', padding: isMobile ? '35px 25px' : '40px', border: '1px solid var(--border-soft)', boxShadow: '0 10px 40px rgba(0,0,0,0.03)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ color: 'var(--text-light)', lineHeight: 1.8, fontSize: '1.05rem', margin: 0 }}>No. 865, Dr. Danister De Silva Mawatha, Baseline Road, Colombo 9, Orugodawatta.</p>
            </div>

            {/* 7. Certifications & Partners (Wide 2/3) */}
            <div className="hover-lift" style={{ gridColumn: isMobile ? 'span 1' : 'span 2', background: 'var(--white)', borderRadius: '32px', padding: isMobile ? '35px 25px' : '50px 60px', border: '1px solid var(--border-soft)', boxShadow: '0 10px 40px rgba(0,0,0,0.03)', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '30px' : '40px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}><div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--primary-red)' }}></div><p style={{ color: 'var(--text-light)', fontWeight: 600, margin: 0 }}>ISO 9001:2015</p></div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}><div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--primary-red)' }}></div><p style={{ color: 'var(--text-light)', fontWeight: 600, margin: 0 }}>ISO 14001:2015</p></div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}><div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--primary-red)' }}></div><p style={{ color: 'var(--text-light)', fontWeight: 600, margin: 0 }}>ISO 45001:2018</p></div>
                </div>
              </div>

              <div style={{ borderLeft: isMobile ? 'none' : '1px solid var(--border-soft)', paddingTop: isMobile ? '20px' : '0', paddingLeft: isMobile ? '0' : '40px', borderTop: isMobile ? '1px solid var(--border-soft)' : 'none' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--text-light)', fontSize: '0.95rem', lineHeight: 1.6, margin: 0, fontWeight: 500 }}>HNB, DFCC, Sampath, NDB, Commercial, Peoples Bank & NTB</p>
                </div>
              </div>
