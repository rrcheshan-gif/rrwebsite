          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "60px", alignItems: "center" }}>
            ...
            <div style={{ flex: "1", minWidth: "300px" }}>
              <div style={{ borderRadius: "24px", overflow: "hidden", position: "relative", boxShadow: "0 20px 50px rgba(0,0,0,0.1)" }}>
                <img src="/images/hero-road-roller.jpg" alt="RR Construction Machinery" style={{ width: "100%", height: "auto", display: "block" }} />
        ...
        <div className="container" style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 16px" }}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "80px", alignItems: "center" }}>
            ...
            <div style={{ flex: 1.5, minWidth: 'min(100%, 350px)' }}>
              <div style={{ display: "flex", alignItems: "center", gap: "15px", marginBottom: "20px" }}>
                <div style={{ width: "40px", height: "3px", background: "var(--primary-red)" }}></div>
                <h3 style={{ color: "var(--primary-red)", fontSize: "1rem", textTransform: "uppercase", letterSpacing: "2px", margin: 0, fontWeight: 800, fontFamily: "var(--font-heading)" }}>Message from the MD</h3>
              </div>
      ...
      <section style={{ padding: isMobile ? "60px 20px" : "100px 20px", textAlign: "center" }}>
        <div className="container" style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: isMobile ? "2.2rem" : "3.5rem", color: "var(--text-dark)", fontFamily: "var(--font-heading)", fontWeight: 800, marginBottom: "20px", lineHeight: 1.2 }}>
            Engineering Sri Lanka's <span className="text-gradient">Tomorrow</span>
          </h2>
