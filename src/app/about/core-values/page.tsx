  ...
  const values = [
    {
      ...
      desc: "We operate with absolute transparency, honesty, and uncompromising ethical standards in every contract we undertake."
    },
    {
      icon: <Target size={32} />,
      title: "Commitment to Quality",
      desc: "Excellence is not an option; it is our baseline. Our ISO 9001 certification reflects our dedication to flawless execution."
    },
    {
      icon: <Users size={32} />,
      title: "Team Empowerment",
      desc: "Our 1,800+ workforce is our greatest asset. We invest heavily in training, safety, and mutual respect."
    },
    {
      icon: <Zap size={32} />,
      title: "Innovation & Efficiency",
      desc: "By integrating modern engineering methodologies and maintaining our own massive fleet, we eliminate delays and drive efficiency."
    },
    {
      icon: <Leaf size={32} />,
      title: "Sustainability",
      desc: "We build for tomorrow. Our ISO 14001 certification ensures our environmental footprint is minimized on every site."
    },
    {
      icon: <Award size={32} />,
      title: "Safety First",
      desc: "Zero harm is our standard. Our ISO 45001 certified protocols ensure the physical well-being of everyone on our sites."
    }
  ];
