...
export default function OngoingProjects() {
  ...
  const filteredProjects = ongoingProjects.filter((p: any) => 
      ...
      <div className="container" style={{ padding: "60px 20px" }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '30px' }}>
          <div style={{ display: 'flex', background: 'var(--bg-base)', borderRadius: '50px', padding: '6px', border: '1px solid var(--border-soft)' }}>
             ...
             <Link href="/ongoing" style={{ padding: '12px 40px', borderRadius: '50px', background: 'var(--primary-red)', color: 'white', fontWeight: 'bold', textDecoration: 'none', boxShadow: '0 4px 15px rgba(229,57,53,0.3)' }}>
               Ongoing Projects
             </Link>
          </div>
        </div>
              ...
              <CardWrapper key={index} {...wrapperProps}>
                ...
                >
                  ...
                  <div style={{ position: "absolute", top: "12px", left: "12px", display: "flex", gap: "6px", flexWrap: "wrap", zIndex: 2 }}>
                    ...
                    <span style={{ padding: '4px 10px', background: 'rgba(217, 119, 6, 0.85)', backdropFilter: 'blur(8px)', color: 'white', borderRadius: '6px', fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.3px', border: '1px solid rgba(255,255,255,0.25)' }}>Ongoing</span>
                  </div>
                  </div>
