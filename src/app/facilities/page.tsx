...
export default function QuarriesAggregates() {
  ...
  return (
    <div style={{ paddingTop: "0px", minHeight: "100vh", backgroundColor: "var(--bg-light)" }}>
      ...
      <section className="page-header" style={{ backgroundImage: "url('/images/page-headers/quarry-hero-new.jpg')", padding: "90px 20px 40px", textAlign: "center", position: "relative", backgroundSize: "cover", backgroundPosition: "center",  borderRadius: '32px',
      ...
      <section id="inquiry" style={{ padding: "130px 20px 50px", background: "var(--bg-base)" }}>
