...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'High-capacity asphalt plant operations and highway and expressway construction in Sri Lanka.',
    url: 'https://www.rrconstruction.lk/materials/asphalt',
    type: 'website'
  }
};
