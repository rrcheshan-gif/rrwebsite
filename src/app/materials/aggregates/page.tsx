      ...
      <section style={{ padding: isMobile ? '60px 10px' : '100px 20px', backgroundColor: 'var(--white)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <Link href="/materials/m-sand" style={{ display: 'inline-flex', alignItems: 'center', padding: '12px 24px', backgroundColor: 'var(--primary-red)', color: 'var(--white)', borderRadius: '8px', textDecoration: 'none', fontWeight: 600 }}>
