...
export const metadata: Metadata = {
  ...
  description: 'RR Construction produces crushed stone aggregates and quarry products in Sri Lanka for road construction, concrete production, and heavy civil engineering applications.',
