  ...
  return (
    <>
      ...
      <section className="hero-contained" style={{ padding: '0', paddingTop: '130px', paddingBottom: '80px', backgroundColor: 'var(--bg-light)', display: 'flex', justifyContent: 'center' }}>
        <div style={{ position: 'relative', width: 'calc(100% - 40px)', maxWidth: '1800px', height: 'clamp(550px, 70vh, 750px)', borderRadius: 'clamp(24px, 5vw, 48px)', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.1)', transform: 'translateZ(0)', isolation: 'isolate', WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
        {/* Background Slider */}
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "25px" }}>
            {[
              ...
              <div key={i} className="modern-service-card glass-panel hover-lift" style={{ width: "min(100%, 340px)", minHeight: "280px", position: "relative", overflow: "hidden", padding: 0, borderRadius: "20px" }}>
