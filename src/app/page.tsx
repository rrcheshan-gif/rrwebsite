        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <div className="services-grid-6">
            {[
              ...
              { title: "Railway Civil Works", img: "/images/projects/new-folder/maho-railway/2.jpg", icon: <Train size={30} />, text: "Modernizing railway infrastructure and executing large-scale civil components for track upgrades." }
            ].map((srv, i) => (
