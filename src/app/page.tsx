              ...
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', marginBottom: 'clamp(14px, 2.5vh, 28px)' }}>
                    ...
                    <div style={{ color: "#ffffff", fontWeight: 800, fontSize: 'clamp(0.75rem, 1.3vw, 0.9rem)', letterSpacing: '3px', textTransform: 'uppercase', textShadow: "1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 0 6px 15px rgba(0,0,0,0.7)" }}>
                      {slide.tag}
                    </div>
                  </div>
                )}
                  ...
                  {/* Main Heading */}
                  <h2 style={{ fontFamily: 'var(--font-heading)', color: "#ffffff", fontSize: 'clamp(2.4rem, 5.5vw, 4.8rem)', lineHeight: 1.1, marginBottom: 'clamp(14px, 2.5vh, 22px)', fontWeight: 900, textAlign: 'center', letterSpacing: '-0.02em', textShadow: "1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 0 6px 15px rgba(0,0,0,0.7)" }}>
                    {slide.heading1}{slide.heading2 && <><br /><span style={{ color: 'var(--primary-red)', textShadow: '1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 0 6px 15px rgba(0,0,0,0.7)' }}>{slide.heading2}</span></>}{slide.heading3 && <><br />{slide.heading3}</>}
                  </h2>
                  ...
                  {/* Description */}
                  <p style={{ fontSize: 'clamp(0.95rem, 1.5vw, 1.25rem)', lineHeight: 1.8, color: "rgba(255, 255, 255, 0.9)", maxWidth: '780px', fontWeight: 600, textAlign: 'center', marginBottom: 'clamp(22px, 4vh, 40px)', textShadow: "1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 0 6px 15px rgba(0,0,0,0.7)" }}>
                    {slide.desc}
                  </p>
