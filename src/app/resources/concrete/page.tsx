...
export default function ConcretePage() {
  ...
  return (
    <main style={{ backgroundColor: "var(--white)", minHeight: "100vh" }}>
      {/* Page Header */}
      <section className="page-header" style={{ position: 'relative', backgroundImage: "url('/images/resources/concrete/vadduvakal-plant.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', color: 'var(--white)', padding: '70px 20px', textAlign: 'center' }}>
