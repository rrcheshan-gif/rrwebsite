      ...
      <section style={{ padding: "80px 20px 50px", backgroundColor: "var(--white)" }}>
        <div className="container" style={{ maxWidth: "1500px", margin: "0 auto" }}>
          <div style={{ textAlign: "left", marginBottom: "50px", maxWidth: "1000px" }}>
            ...
            <p style={{ color: "var(--text-light)", fontSize: "1.2rem", fontStyle: "italic", marginBottom: "30px", paddingLeft: "clamp(18px, 5vw, 55px)", borderLeft: "2px solid rgba(229, 57, 53, 0.3)" }}>Fueling Infrastructure Development in the Northern Province.</p>
