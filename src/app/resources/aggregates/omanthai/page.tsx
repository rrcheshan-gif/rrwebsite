...
export default function OmanthaiPlant() {
  ...
  return (
    <div style={{ paddingTop: "0px", minHeight: "100vh", backgroundColor: "var(--white)" }}>
      ...
      {/* Page Header */}
      <section className="page-header" style={{ position: 'relative', backgroundImage: "url('/images/projects/Mahiyanganaya/3.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', color: 'var(--white)', padding: '70px 20px', textAlign: 'center' }}>
        ...
        <div className="container" style={{ maxWidth: "1500px", margin: "0 auto" }}>
          <div style={{ textAlign: "left", marginBottom: "50px", maxWidth: "100%" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "15px", marginBottom: "15px" }}>
              ...
              <h4 style={{ color: "var(--primary-red)", fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", margin: 0, fontSize: "0.9rem" }}>Omanthai Metal Crusher Plant</h4>
            </div>
            ...
            <p style={{ color: "var(--text-light)", fontSize: "1.2rem", fontStyle: "italic", marginBottom: "30px", paddingLeft: "20px", borderLeft: "2px solid rgba(229, 57, 53, 0.3)" }}>Fueling Infrastructure Development in the Northern Province.</p>
      ...
      <section style={{ padding: "60px 20px 50px", background: "var(--bg-base)" }}>
        <div className="container" style={{ maxWidth: "1500px", margin: "0 auto" }}>
          <div style={{ textAlign: "left", marginBottom: "50px", maxWidth: "100%" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2rem, 5vw, 3.2rem)", color: "var(--text-dark)", margin: "0", fontWeight: 800 }}>Our Omanthai <span className="text-gradient" style={{ fontWeight: 300 }}>Facility</span></h2>
          </div>
      ...
      <section style={{ padding: "60px 20px 50px", backgroundColor: "var(--white)" }}>
        <div className="container" style={{ maxWidth: "1500px", margin: "0 auto" }}>
          <div style={{ textAlign: "left", marginBottom: "50px", maxWidth: "100%" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2rem, 5vw, 3.2rem)", color: "var(--text-dark)", marginBottom: "15px", fontWeight: 800 }}>OMANTHAI PLANT: Our <span className="text-gradient" style={{ fontWeight: 300 }}>Products</span></h2>
