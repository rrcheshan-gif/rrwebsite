...
export default function ThudugalaPlant() {
  ...
  return (
    <div style={{ paddingTop: "0px", minHeight: "100vh", backgroundColor: "var(--white)" }}>
      {/* Page Header */}
      <section className="page-header" style={{ position: 'relative', backgroundImage: "url('/images/projects/Mawanella/2.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', color: 'var(--white)', padding: '70px 20px', textAlign: 'center' }}>
