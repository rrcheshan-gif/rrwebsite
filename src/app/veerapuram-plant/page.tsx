...
export default function VeerapuramPlant() {
  ...
  return (
    <div style={{ paddingTop: "100px", minHeight: "100vh", backgroundColor: "var(--bg-light)" }}>
      ...
      {/* Page Header */}
      <section className="page-header" style={{ backgroundImage: "url('/images/brochure-contact.jpg')", padding: "80px 20px", textAlign: "center", position: "relative", backgroundSize: "cover", backgroundPosition: "center" }}>
