    ...
    <div style={{ paddingTop: "0px", minHeight: "100vh", backgroundColor: "var(--bg-light)" }}>
      ...
      >
        <div className="absolute-back-btn" style={{ position: "absolute", top: "110px", left: "clamp(20px, 4vw, 40px)", zIndex: 99 }}>
          <Link href="/sustainability" style={{ color: "#fff", textDecoration: "none", borderBottom: "1px solid rgba(255,255,255,0.5)", paddingBottom: "3px", fontWeight: "bold", letterSpacing: "1px", fontSize: "0.85rem", textShadow: "0 2px 5px rgba(0,0,0,0.8)", display: "inline-block" }}>&larr; Back to Sustainability
            </Link>
        </div>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "15px", marginBottom: "15px" }}>
            ...
            <h1 style={{ color: "white", fontFamily: "var(--font-heading)", fontSize: "clamp(1.8rem, 6vw, 4.2rem)", margin: 0, fontWeight: 800, textShadow: "0 4px 20px rgba(0,0,0,0.85)" }}>Social <span className="text-gradient" style={{ fontWeight: 600 }}>Responsibility</span></h1>
      ...
      <section style={{ padding: "60px 20px 50px", background: "var(--white)" }}>
        <div className="container" style={{ maxWidth: "1440px", margin: "0 auto", padding: "0 16px" }}>
          <div style={{ textAlign: "center", marginBottom: "60px" }}>
            ...
            <div className="glass-panel hover-lift" style={{ background: "var(--bg-light)", padding: isMobile ? "30px 20px" : "40px", borderRadius: "20px", border: "1px solid var(--border-soft)", display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "flex-start" }}>
              <div style={{ background: "var(--white)", padding: "20px", borderRadius: "16px", boxShadow: "0 10px 20px rgba(0,0,0,0.05)", flexShrink: 0 }}>
                <MapPin size={40} color="var(--primary-red)" />
              </div>
              <div>
            ...
            <div className="glass-panel hover-lift" style={{ background: "var(--bg-light)", padding: isMobile ? "30px 20px" : "40px", borderRadius: "20px", border: "1px solid var(--border-soft)", display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "flex-start" }}>
              <div style={{ background: "var(--white)", padding: "20px", borderRadius: "16px", boxShadow: "0 10px 20px rgba(0,0,0,0.05)", flexShrink: 0 }}>
                <BookOpen size={40} color="var(--primary-red)" />
              </div>
              <div>
            ...
            <div className="glass-panel hover-lift" style={{ background: "var(--bg-light)", padding: isMobile ? "30px 20px" : "40px", borderRadius: "20px", border: "1px solid var(--border-soft)", display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "flex-start" }}>
              <div style={{ background: "var(--white)", padding: "20px", borderRadius: "16px", boxShadow: "0 10px 20px rgba(0,0,0,0.05)", flexShrink: 0 }}>
                <Building2 size={40} color="var(--primary-red)" />
              </div>
              <div>
