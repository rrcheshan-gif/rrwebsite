        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <h1 style={{ color: "white", fontFamily: "var(--font-heading)", fontSize: "clamp(1.8rem, 6vw, 4.2rem)", margin: 0, fontWeight: 800, textShadow: "0 4px 20px rgba(0,0,0,0.85)" }}>Occupational <span style={{ color: "var(--primary-red)" }}>Health & Safety</span></h1>
            <p style={{ color: "#cbd5e1", fontSize: "1.1rem", maxWidth: "550px", lineHeight: 1.6, margin: "10px 0 0 0" }}>
               A zero-harm culture ensuring the well-being of our workforce and communities.
            </p>
      ...
      <section style={{ padding: "60px 20px 50px", background: "var(--white)" }}>
        <div className="container" style={{ maxWidth: "1500px", margin: "0 auto", padding: "0 16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "25px" }}>
            ...
            <div className="glass-panel hover-lift" style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "flex-start", background: "var(--bg-light)", padding: "40px", borderRadius: "20px", border: "1px solid var(--border-soft)" }}>
              <div style={{ background: "rgba(229, 57, 53, 0.1)", padding: "20px", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <AlertTriangle size={40} color="var(--primary-red)" />
              </div>
              <div>
            ...
            <div className="glass-panel hover-lift" style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "flex-start", background: "var(--bg-light)", padding: "40px", borderRadius: "20px", border: "1px solid var(--border-soft)" }}>
              <div style={{ background: "rgba(229, 57, 53, 0.1)", padding: "20px", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <HardHat size={40} color="var(--primary-red)" />
              </div>
              <div>
            ...
            <div className="glass-panel hover-lift" style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "flex-start", background: "var(--bg-light)", padding: "40px", borderRadius: "20px", border: "1px solid var(--border-soft)" }}>
              <div style={{ background: "rgba(229, 57, 53, 0.1)", padding: "20px", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <UserCheck size={40} color="var(--primary-red)" />
              </div>
              <div>
