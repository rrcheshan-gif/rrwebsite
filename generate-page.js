        ...
        <div className="container" style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "30px" }}>
            {[
              ...
              { title: "Teamwork", desc: \Collaboration is our strength. We foster an environment where our \ employees work seamlessly.\, icon: <Users size={32} color="var(--primary-red)" /> },
            ].map((val, idx) => (
...
fs.writeFileSync('src/app/about/vision-mission/page.tsx', pageContent, 'utf8');
console.log('Successfully generated page with accurate UTF-8 encoding and toggle!');
